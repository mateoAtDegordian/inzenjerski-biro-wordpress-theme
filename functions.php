...
function ingbiro_building_banner() {
	printf(
		'<div class="building-banner" aria-hidden="true"><video class="building-banner__video" autoplay muted loop playsinline preload="auto" tabindex="-1" data-ambient-video disablepictureinpicture controlslist="nodownload nofullscreen noremoteplayback"><source src="%1$s" type="video/mp4"></video></div>',
